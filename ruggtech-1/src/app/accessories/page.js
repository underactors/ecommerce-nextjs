    ...
    return (
      <div className="container" style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-gray)', fontSize: '18px' }}>Loading accessories...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container">
      <nav style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '20px 0', fontSize: '14px', color: 'var(--text-gray)' }}>
        ...
        <span>/</span>
        <span style={{ color: 'var(--text-light)' }}>Accessories</span>
      </nav>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', background: 'rgba(253, 186, 116, 0.3)', padding: '8px 20px', borderRadius: '30px', marginBottom: '16px' }}>
            <FontAwesomeIcon icon={faPlug} style={{ color: '#fdba74' }} />
            <span style={{ color: 'white', fontWeight: '600', fontSize: '14px' }}>GADGETS & MORE</span>
          </div>
          
          <h1 style={{ color: 'white', fontSize: 'clamp(28px, 5vw, 42px)', fontWeight: '800', marginBottom: '12px', textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
            <FontAwesomeIcon icon={faHeadphones} style={{ marginRight: '12px' }} />
            Accessories
          </h1>
          
          <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '18px', maxWidth: '600px', margin: '0 auto' }}>
            Phone accessories, electronics, watches, and more. Everything you need to complement your devices.
          </p>
        </div>
      </div>
      ...
      {filteredProducts.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '80px 20px', background: 'var(--card-bg)', borderRadius: '16px', border: '1px solid var(--border-color)' }}>
          <FontAwesomeIcon icon={faHeadphones} size="4x" style={{ color: 'var(--text-gray)', marginBottom: '20px' }} />
          <h2 style={{ color: 'var(--text-light)', marginBottom: '10px' }}>No Accessories Available</h2>
          <p style={{ color: 'var(--text-gray)', marginBottom: '30px' }}>Check back soon for new accessories!</p>
